...
/**
 * Handles `job.retried` deliveries. Refreshes the product heartbeat and
 * flips the `ps_qamera_packshot_job` mirror to `in_progress` (per the
 * PackshotJobUpdater status map) — no output/error yet, those land on the
 * terminal event. If the mirror row does not exist yet, the updater's
 * pre-submit-race path handles it.
 */
